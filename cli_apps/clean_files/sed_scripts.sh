...
sed -re "s/' , '/,/g" res12.txt > res16.txt
# sed -re "s/ ',  /, /g" res16.txt > res17.txt
sed -re "s/,  /, /g" res16.txt > res19.txt
...
sed -re "s/.,,/, /g" res20.txt > res24.txt
