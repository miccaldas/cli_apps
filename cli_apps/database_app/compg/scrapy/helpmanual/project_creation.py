...
def project_creation():
    ...
    Runs *Scrapy's* command to start a project::
        ...
        scrapy startproject helpmanual_project
    """
    cmmd = "/usr/bin/scrapy startproject helpmanual_project"
    subprocess.run(cmmd, cwd=hlp, shell=True)
...
def spider():
    ...
    with open(f"{hlp}spiders.bin", "rb") as f:
