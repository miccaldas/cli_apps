...
class QMLIMPORTSCANNER_QT5_SPIDER(scrapy.Spider):
    name = 'qmlimportscanner_qt5_spider'

    start_urls = ['https://doc.qt.io/qt-5/qtqml-cmake-qt5-import-qml-plugins.html']
