...
# @snoop
def epoch_counting_info(vr=universal_variables()):
    """
    ...
    try:
        ...
        print_template(
            f"Couldn't move {hlp.split('/')[-1]}helpmanual_data.bin because of:\n[/][bold #F31559]{e}"
        )
        raise SystemExit
    data_counting()
...
if __name__ == "__main__":
    vr = "tintin.txt", "tantan.txt"
    epoch_counting_info(vr)
